...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
  ...
  private static final String[] PUBLIC = {"/auth/register", "/api/oauth/token"};
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    //liberar a renderização de frames caso o perfil do ambiente de excecução seja teste(por causa do h2)
